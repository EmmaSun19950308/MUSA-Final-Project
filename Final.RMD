...
This section conducted cross-validation on both models. The outputs include the ROC, sensitivity and specificity across the 100 k-folds. Both models generalize well with regard to sensitivity, while neither of models generalize well with specificity. Since we are more concerned about the sensitivity as mentioned above, such an outcome is satisfied. 
